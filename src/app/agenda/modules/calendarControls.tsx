...
import { Views, type NavigateAction, type View } from "react-big-calendar";
...
interface CalendarControlsProps {
  ...
  onNavigate: (newDate: Date, action?: NavigateAction | undefined) => void;
  onNewAppointment: () => void;
  viewMap: { [key: string]: View };
}
